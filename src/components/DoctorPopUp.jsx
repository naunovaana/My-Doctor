...
export default function DoctorPopUp({
  ...
  return (
    <div className="bg-cardBg rounded-2xl text-black w-full">
      ...
      <div className="rounded-3xl bg-lightblue/30 border-2 border-gray-400 flex flex-col  items-center px-2 pt-7 text-center space-y-2">
          ...
          <div className="flex flex-row space-x-2 pt-2">
            <a href="/">
              <div className="p-1 rounded-full border-2 border-gray-400">
                <FontAwesomeIcon
                  icon={faPhone}
                  className="w-7 h-6 text-gray-800"
                />
              </div>
            </a>
            <a href="/">
      ...
      <div className="flex flex-col pt-4 items-center">
        ...
        <div className="text-[10px] mt-2">
          <p>
            *Disclaimer this is not an official doctors document, it may contain
            deprecated or irrelevant information
          </p>
        </div>
      </div>
    </div>
