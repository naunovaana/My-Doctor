    ...
    <div className=" rounded-2xl  w-full  flex flex-col items-center ">
      ...
      <form action="/" className=" w-full h-full px-4 flex flex-col">
        <div className="flex flex-col py-4">
          <label htmlFor="name" className="ml-3 text-sm text-gray-500">
            Цело име и презиме*
          </label>
          <input
            type="text"
            ...
            name="fname"
            value="Ана Наунова"
            className="rounded-3xl p-2 w-full border-2 border-cardBorder  text-navbarText font-semibold"
          />
        </div>
        <div className="flex flex-col py-4">
          <label htmlFor="email" className="ml-3 text-sm text-gray-500">
            Е-пошта*
          </label>
          <input
            type="email"
            id="email"
            name="email"
            value="naunova.a22@yahoo.com"
            className="rounded-2xl  p-2 w-full border-2 border-cardBorder  text-navbarText font-semibold"
          />
        </div>
        <div className="flex flex-col py-4">
          <label htmlFor="message" className="ml-3 text-sm text-gray-500">
            {description}
          </label>
          <textarea
            name="comment"
        ...
        <div className=" flex justify-center p-5">
          <input
            type="submit"
            value="Submit"
            className="bg-customButton text-white py-2 px-10 rounded-full bg-btnPrimary"
          />
        </div>
      </form>
